...
internal class SuikaLitFurShaderGUI : ShaderGUI
{
    #region EnumDefine
    ...
    void DoAlbedoArea(Material material)
    {
        ...
        m_MaterialEditor.TexturePropertySingleLine(Styles.noiseText, noiseTex, noiseTex_ST, threshold);
        ...
        m_MaterialEditor.ShaderProperty(furLength, "Length", 1);
